                ...
                (function(__iced_k) {
                    ...
                    if (err) {
                        ...
                        $.ajax({
                            ...
                            data:{
                                value: hex,
                                file: "symmetric_encrypted.txt",
                                type: "write"
                            }
                        })
                            .done(function( msg ) {
                                alert( "Message encrypted!" );
                                $("#download_SE").html("<button class='btn btn-encrypt btn-default' type='button' id='download_SE'>Download SE</button>");
                            });
                    }
                    return input_change();
                });
...
$('#download_SE').click(function(e) {
    e.preventDefault();  //stop the browser from following
    window.location.href = 'text_files/symmetric_encrypted.txt';
});